...
def run_step7_make_template(
    ...
    template_path = str(Path(output_dir) / "step7_pbn_template.png")
    colored_debug_path = str(Path(output_dir) / "step7_colored_debug.png")
    palette_sheet_path = str(Path(output_dir) / "step7_palette_sheet.png")
    result_path = str(Path(output_dir) / "step7_result.json")
